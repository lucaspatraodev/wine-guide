      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-14">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-bold text-[#14213D] uppercase ">
                What's used
              </h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" className="text-white hover:text-[#14213D]">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <a href="#" className="text-white hover:text-[#14213D] ms-5">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
