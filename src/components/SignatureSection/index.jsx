  ...
  return (
    <section className="flex flex-col items-center max-w-screen gap-4 h-auto my-12 p-4 bg-white">
      <div className="flex flex-col items-center">
        <h1 className="text-[#FCA311] font-bold text-3xl md:text-4xl">
          How it works
        </h1>
      ...
      <Link
        to="/about"
        className="flex justify-center bg-[#14213D] hover:bg-[#FCA311] text-white w-[350px] sm:p-10 sm:text-2xl sm:m-4 md:w-48 font-bold p-4 md:py-2 md:px-4 rounded"
      >
        Sign now!
      </Link>
    </section>
